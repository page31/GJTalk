...
Label_ForeImage:
	...
	void CEditUI::DoEvent(TEventUI& event)
	{
		...
		{
			if(event.ptMouse.x>m_rcTextPadding.left&&event.ptMouse.x<=m_rcTextPadding.right
				&&event.ptMouse.y>m_rcTextPadding.top&&event.ptMouse.y<m_rcTextPadding.bottom)
